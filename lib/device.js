...
module.exports = Thing.type(BaseAppliance => class MiioAppliance extends BaseAppliance {
	static get type() {
		return 'miio';
	}
	...
	constructor(options) {
		...
		this.id = 'miio:' + (options.id || '[' + options.address + ']');
		this.miioModel = options.model || 'unknown';
		this.capabilities = [];
